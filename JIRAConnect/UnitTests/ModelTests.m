...
-(void)testIssue
{
    ...
    NSDictionary *issueDict = [NSDictionary
            dictionaryWithObjectsAndKeys:@"NERDS-123",                    @"key",
                                         ...
                                         NO,                              @"hasupdates",
                                         nil];
    JMCIssue *issue = [JMCIssue issueWith:[[NSString alloc] initWithData:[NSJSONSerialization dataWithJSONObject:issueDict options:nil error:nil] encoding:NSUTF8StringEncoding] requestId:@"somerandomuuid"];
