...
{
    NSString *filePath = [[NSBundle bundleForClass:[self class]] pathForResource:@"JMCTestConfiguration" ofType:@"plist"];
    JMCOptions *options2 = [JMCOptions optionsWithContentsOfFile:filePath];
